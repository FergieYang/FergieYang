...
|---------|-------------|
| [**Meetsocial-Sinoclick-Client-Segmentation**](https://github.com/FergieYang/Meetsocial-Sinoclick-Client-Segmentation) | Full client segmentation pipeline for Meetsocial's Sinoclick ad platform |
| [**LightGBM + DNN Ensemble**](https://github.com/FergieYang/-LightGBM-DNN-) | Alibaba Cloud Tianchi competition, hybrid ensemble approach |
| [**Mobile Purchase Prediction**](https://github.com/FergieYang/Prediction-and-analysis-of-mobile-user-purchasing-behavior-on-the-Internet-platform-based-on-MySQL) | MySQL-driven behavioral analytics and purchase prediction |
...
| Project | What it does |
|---------|-------------|
| [**llm-teaming-verification-hallucination**](https://github.com/FergieYang/llm-teaming-verification-hallucination) | Multi-LLM teaming: cross-check vs single-judge verification on ConTRoL |
| [**Effective Rank Diagnostics**](https://github.com/FergieYang/Effective-Rank-as-a-Diagnostic-for-Representation-Bottlenecks-and-Compression-in-Language-Models) | Information-theoretic diagnostics for representation bottlenecks in LMs |
...
| Project | What it does |
|---------|-------------|
| [**distributed-global-srht**](https://github.com/FergieYang/distributed-global-srht) | Distributed regression with SRHT sketching, theory and algorithms |
...
| Project | What it does |
|---------|-------------|
| [**Heartbridge-AI**](https://github.com/FergieYang/Heartbridge-AI) | PulseNYC Hackathon — AI-powered healthcare matching platform |
| [**Nexus**](https://github.com/FergieYang/Nexus) | Claude Hackathon (Columbia x NYU) — intelligent business operations tool |
| [**HVAC-Margin-Rescue-Contractor**](https://github.com/FergieYang/HVAC-Margin-Rescue-Contractor) | Pulse Hackathon — contractor margin optimization with AI |
...
| Platform | Link |
|----------|----------------------|
| X (Twitter) | [@LotusCross39](https://x.com/Zygote39) |
